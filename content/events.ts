...
export const events: Event[] = [
  {
    ...
    priceLabel: "Free RSVP · Limited places",
        ...
        people: [
          {
            ...
            bio: "Stefania studies what happens when algorithms decide what people see. Her research looks at recommendation, moderation and filtering tools — the invisible machinery behind every feed — and asks what they do to opinion, to work, and to culture.\n\nShe started in mathematics at the University of Cambridge, then took a master's in Logic at the ILLC in Amsterdam, cum laude. Her PhD at the University of Zurich, on the societal impact of these systems, was awarded summa cum laude. In 2025 she received the FAN Award for outstanding scientific achievement in Law and Economics. She is now a postdoctoral researcher at ETH Zurich working on responsible automation.\n\nRecently she worked with Bluesky feeds to test a deceptively simple question: if you change how posts are ranked, how much does what people see change with it? She also co-designs university courses — Game Theory and Algorithmic Concepts, Social Computing — that put this research in front of the engineers who will build the next generation of these systems. Outside the lab she enjoys board games, Dungeons & Dragons, and hiking.",
          ...
          },
          {
            ...
            bio: "Sophia has spent ten years on the other side of the feed. As a designer and strategist in agency and brand roles, she has built communication platforms for Audemars Piguet, FC Bayern, BMW, Burger King, Paulaner and Coop — work that reached millions of people through the platforms we'll be talking about.\n\nShe trained as a designer and holds a BA in International Business Studies from FAU Erlangen-Nürnberg. She was named 30u30 Swiss Communication and is a Cannes Young Lion medalist.\n\nShe now runs Smove AI, which builds AI agents for Swiss and German creative agencies — one each for Instagram, LinkedIn and Facebook — that draft social content and pass it to a human for approval before publishing. Ten years of building for these platforms, and a daily view of where they're heading next.\n\nOutside the work she runs MAPO, an NGO supporting education for children in Tanzania, is a committed Rotarian, and plays chess and piano.",
