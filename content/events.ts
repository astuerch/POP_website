        ...
        people: [
          {
            ...
            bio: "Stefania studies what happens when algorithms decide what people see. Her research looks at the recommendation, moderation and filtering tools behind every feed, and asks what they do to opinion, to work, and to culture. She read mathematics at Cambridge, took a master's in Logic in Amsterdam (cum laude), and earned her PhD at the University of Zurich (summa cum laude) on the societal impact of these systems. In 2025 she won the FAN Award in Law and Economics. Now a postdoctoral researcher at ETH Zurich, she recently used Bluesky feeds to ask a deceptively simple question: change how posts are ranked, and how much does what people see change with it? Outside the lab: board games, D&D and hiking.",
          ...
          },
          {
            ...
            bio: "Sophia has spent ten years on the other side of the feed. As a designer and strategist, she has built communication for Audemars Piguet, FC Bayern, BMW, Burger King and Coop, work that reached millions through the platforms we'll be discussing. She holds a BA in International Business Studies from FAU Erlangen-Nürnberg, was named 30u30 Swiss Communication, and is a Cannes Young Lion medalist. She now runs Smove AI, which builds AI agents for Swiss and German agencies that draft social content and pass it to a human before publishing. Outside work she runs MAPO, an NGO supporting education for children in Tanzania, is a committed Rotarian, and plays chess and piano.",
